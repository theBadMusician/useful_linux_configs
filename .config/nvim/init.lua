...
-- Optional: Configure telescope for git operations
require('telescope').setup {
  extensions = {
    fzf = {
      fuzzy = true,
...
-- Optional: Add keymaps for telescope git commands
vim.api.nvim_set_keymap('n', '<leader>vc', '<cmd>Telescope git_commits<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<leader>vb', '<cmd>Telescope git_branches<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<leader>vs', '<cmd>Telescope git_status<CR>', {noremap = true, silent = true})
